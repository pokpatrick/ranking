...
*/
    ...
    public List<Player> onePartition( String argument )
    {
        final ArrayList<Player> result = new ArrayList<Player>();

        for( final Player player : _playerArray )
        {
            if(super.getPartitionArg( player.getPlayerId() ).equals( argument ))
            {
                result.add(player);
            }
        }
        ...
        public List<Player> Partition( String argument )
    {
        final ArrayList<Player> result = new ArrayList<Player>();

        result.addAll( onePartition( argument ) );
        return( result );
    }
}
